...
<p>If you were charged twice for the same ticket, if a payment failed but you were still charged, or if you run into any other payment-related technical issue, write to us at [TO COMPLETE — support email] — this kind of issue gets fixed promptly, regardless of the event's sales policy.</p>

<h2>7. How to request a refund</h2>
<p>For anything related to a specific event, contact the organizer first (their contact details usually appear in your order confirmation email). If you can't reach them, or the issue is a platform-level technical problem rather than something about the event itself, write to us at [TO COMPLETE — support email].</p>

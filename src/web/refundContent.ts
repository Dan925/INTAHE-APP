...
<p class="text-secondary small">Dernière mise à jour : 22 septembre 2026</p>
...
<h2>5. Vente rapide et Vente à la porte</h2>
<p>Les achats faits via Vente rapide (produits/services à prix fixe, ex. une coupe de cheveux) ou Vente à la porte (billets achetés directement sur place avec un lecteur de carte) sont aussi des ventes finales. <strong>Contrairement aux billets achetés en ligne, Intahé n'offre pas encore d'outil de remboursement intégré à la plateforme pour ces deux types de vente</strong> — si un organisateur souhaite rembourser une telle vente, il doit le faire manuellement depuis son propre tableau de bord Stripe. Si tu as un problème avec un achat de ce type, contacte d'abord le commerçant/organisateur directement.</p>

<h2>6. Frais de service</h2>
...
<h2>8. Comment demander un remboursement</h2>
...
const en = `
<h1>Refund policy</h1>
<p class="text-secondary small">Last updated: September 22, 2026</p>
